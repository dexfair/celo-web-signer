...
exports.newDAppBrowserWalletWithSetup = exports.Wallet = void 0;
var wallet_base_1 = require("@celo/wallet-base");
var signer_1 = require("./signer");
var Wallet = /** @class */ (function (_super) {
    __extends(Wallet, _super);
    function Wallet(web3, mobile) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.accounts.forEach(function (address) {
                    ...
                    case 1:
                        _a.accounts = [_b.sent()];
                        this.accounts.forEach(function (address) {
                            _this.addSigner(address, new signer_1.Signer(_this.web3, _this.mobile));
                        });
                        return [2 /*return*/];
                }
            });
