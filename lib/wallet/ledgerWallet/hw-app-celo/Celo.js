...
var EthAppPleaseEnableContractData = require('@ledgerhq/errors').EthAppPleaseEnableContractData;
...
var Celo = /** @class */ (function () {
    function Celo(transport, scrambleKey) {
     ...
     */
    Celo.prototype.getAddress = function (path, boolDisplay, boolChaincode) {
     ...
     */
    Celo.prototype.provideERC20TokenInformation = function (_a) {
        var data = _a.data;
        return this.transport.send(0xe0, 0x0a, 0x00, 0x00, data).then(function () { return true; }, function (e) {
   ...
   */
    Celo.prototype.signTransaction = function (path, rawTxHex) {
        var _this = this;
        var paths = utils_1.splitPath(path);
        var offset = 0;
        ...
        var rlpTx = rlp_1.decode(rawTx);
        var rlpOffset = 0;
        if (rlpTx.length > 6) {
            var rlpVrs = rlp_1.encode(rlpTx.slice(-3));
    ...
    /**
     */
    Celo.prototype.getAppConfiguration = function () {
...
eth.signPersonalMessage("44'/60'/0'/0/0", Buffer.from("test").toString("hex")).then(result => {
   ...
   */
    Celo.prototype.signPersonalMessage = function (path, messageHex) {
        var _this = this;
        var paths = utils_1.splitPath(path);
        var offset = 0;
  ...
  * @example
   ...
   */
    Celo.prototype.signEIP712HashedMessage = function (path, domainSeparatorHex, hashStructMessageHex) {
     ...
     */
    Celo.prototype.starkGetPublicKey = function (path, boolDisplay) {
        var paths = utils_1.splitPath(path);
        var buffer = Buffer.alloc(1 + paths.length * 4);
        buffer[0] = paths.length;
        paths.forEach(function (element, index) {
     ...
     */
    Celo.prototype.starkSignOrder = function (path, sourceTokenAddress, sourceQuantization, destinationTokenAddress, destinationQuantization, sourceVault, destinationVault, amountSell, amountBuy, nonce, timestamp) {
        if (sourceTokenAddress === void 0) { sourceTokenAddress = null; }
        if (destinationTokenAddress === void 0) { destinationTokenAddress = null; }
    ...
    Celo.prototype.starkSignOrder_v2 = function (path, sourceTokenAddress, sourceQuantizationType, sourceQuantization, sourceMintableBlobOrTokenId, destinationTokenAddress, destinationQuantizationType, destinationQuantization, destinationMintableBlobOrTokenId, sourceVault, destinationVault, amountSell, amountBuy, nonce, timestamp) {
        if (sourceTokenAddress === void 0) { sourceTokenAddress = null; }
        if (sourceQuantization === void 0) { sourceQuantization = null; }
        if (sourceMintableBlobOrTokenId === void 0) { sourceMintableBlobOrTokenId = null; }
        if (destinationTokenAddress === void 0) { destinationTokenAddress = null; }
        if (destinationQuantization === void 0) { destinationQuantization = null; }
        if (destinationMintableBlobOrTokenId === void 0) { destinationMintableBlobOrTokenId = null; }
        var sourceTokenAddressHex = maybeHexBuffer(sourceTokenAddress);
        var destinationTokenAddressHex = maybeHexBuffer(destinationTokenAddress);
     ...
     * @return the signature
     */
    Celo.prototype.starkSignTransfer = function (path, transferTokenAddress, transferQuantization, targetPublicKey, sourceVault, destinationVault, amountTransfer, nonce, timestamp) {
        if (transferTokenAddress === void 0) { transferTokenAddress = null; }
     ...
     */
    // eslint-disable-next-line camelcase
    Celo.prototype.starkSignTransfer_v2 = function (path, transferTokenAddress, transferQuantizationType, transferQuantization, transferMintableBlobOrTokenId, targetPublicKey, sourceVault, destinationVault, amountTransfer, nonce, timestamp, conditionalTransferAddress, conditionalTransferFact) {
        if (transferTokenAddress === void 0) { transferTokenAddress = null; }
        if (transferQuantization === void 0) { transferQuantization = null; }
        if (transferMintableBlobOrTokenId === void 0) { transferMintableBlobOrTokenId = null; }
        if (conditionalTransferAddress === void 0) { conditionalTransferAddress = null; }
        if (conditionalTransferFact === void 0) { conditionalTransferFact = null; }
        var transferTokenAddressHex = maybeHexBuffer(transferTokenAddress);
        var targetPublicKeyHex = hexBuffer(targetPublicKey);
     ...
     */
    Celo.prototype.starkProvideQuantum = function (operationContract, operationQuantization) {
        if (operationContract === void 0) { operationContract = null; }
     ...
     */
    // eslint-disable-next-line camelcase
    Celo.prototype.starkProvideQuantum_v2 = function (operationContract, operationQuantizationType, operationQuantization, operationMintableBlobOrTokenId) {
        if (operationContract === void 0) { operationContract = null; }
        var operationContractHex = maybeHexBuffer(operationContract);
        ...
        return this.transport.send(0xf0, 0x08, starkQuantizationTypeMap[operationQuantizationType], 0x00, buffer).then(function () { return true; }, function (e) {
            if (e && e.statusCode === 0x6d00) {
                // this case happen for ETH application versions not supporting Stark extensions
                return false;
            }
     ...
     * @return the signature
     */
    Celo.prototype.starkUnsafeSign = function (path, hash) {
     ...
     */
    Celo.prototype.eth2GetPublicKey = function (path, boolDisplay) {
        var paths = utils_1.splitPath(path);
        var buffer = Buffer.alloc(1 + paths.length * 4);
        buffer[0] = paths.length;
        paths.forEach(function (element, index) {
     ...
     */
    Celo.prototype.eth2SetWithdrawalIndex = function (withdrawalIndex) {
