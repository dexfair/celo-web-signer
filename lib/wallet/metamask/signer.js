...
var Signer = /** @class */ (function () {
    ...
    Signer.prototype.signTransaction = function (addToV, encodedTx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.web3.eth.sign(wallet_base_1.getHashFromEncoded(encodedTx.rlpEncode), encodedTx.transaction.from)];
                    case 1:
                        signature = _a.sent();
    ...
    Signer.prototype.signPersonalMessage = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var signature, v, r, s;
            return __generator(this, function (_a) {
                switch (_a.label) {
