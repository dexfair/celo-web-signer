...
var Celo = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.transport.on('disconnect')];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    onAccountsChanged) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!window.celo) return [3 /*break*/, 5];
                    ...
                    case 5: return [2 /*return*/, this.isConnected];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        provider = _b.sent();
                        if (!(provider && provider.isMetaMask)) return [3 /*break*/, 6];
                        web3 = new web3_1.default(this.network.provider);
                        _a = this;
                    ...
                    case 5:
                        ...
                        this.isConnected = true;
                        return [3 /*break*/, 7];
                    case 6: throw new Error('other ethereum wallet did not support.');
                    case 7: return [2 /*return*/, this.isConnected];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        transport = _a.sent();
                        return [4 /*yield*/, this.ledgerSetup(transport, onAccountsChanged)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    Celo.prototype.ledgerSetup = function (transport, 
    // eslint-disable-next-line no-unused-vars
    onAccountsChanged) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, address, web3;
    ...
    Celo.prototype.changeNetwork = function (network) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!this.isDesktop && this.wallet)) return [3 /*break*/, 2];
                        this.network = network;
                        web3 = new web3_1.default(this.network.provider);
                        this.kit = contractkit_1.newKitFromWeb3(web3, this.wallet);
                        return [4 /*yield*/, this.updateContracts()];
    ...
    Celo.prototype.updateContracts = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        Object.keys(this.contracts).forEach(function (key) {
                            _this.contracts[key] = null;
                        });
