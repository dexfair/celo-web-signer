...
var Celo = /** @class */ (function () {
    ...
    Celo.prototype.init = function (onChainChanged, onAccountsChanged) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var isSupported, list, transport, ledger, _a, address;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        list = _b.sent();
                        if (!(isSupported && list.length > 0)) return [3 /*break*/, 5];
                    ...
                    case 4:
                        ...
                        _b.label = 5;
                    case 5:
                        if (!(!this.isEnable && window['celo'])) return [3 /*break*/, 6];
                        ...
                        return [3 /*break*/, 10];
                    case 6:
                        if (!(!this.isEnable && window['ethereum'])) return [3 /*break*/, 10];
                    ...
                    case 9:
                        ...
                        _b.label = 10;
                    case 10:
                        if (!(this.isEnable && onAccountsChanged)) return [3 /*break*/, 12];
