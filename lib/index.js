...
function createLedgerProvider(transport) {
    var ledger = new Ledger(transport);
    return {
        isLedger: true,
        index: 0,
...
var Celo = /** @class */ (function () {
    ...
    Celo.prototype.init = function (onChainChanged, onAccountsChanged) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var isSupported, listUSB, _a, transport, _b, transport, _c, address;
            var _this = this;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        _a = [];
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, hw_transport_webusb_1["default"].list()];
                    case 4:
                        _a = (_d.sent());
                        _d.label = 5;
                    case 5:
                        listUSB = _a;
                        if (!(listUSB.length > 0)) return [3 /*break*/, 7];
                    ...
                    case 6:
                        ...
                        this.isEnable = true;
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, hw_transport_u2f_1["default"].isSupported()];
                    case 8:
                        _b = (_d.sent());
                    ...
                    case 11:
                        ...
                        _d.label = 12;
                    case 12:
                        if (!(!this.isEnable && window['celo'])) return [3 /*break*/, 13];
                        ...
                        return [3 /*break*/, 17];
                    case 13:
                        if (!(!this.isEnable && window['ethereum'])) return [3 /*break*/, 17];
                        if (!window['ethereum'].isMetaMask) return [3 /*break*/, 15];
                    ...
                    case 16:
                        ...
                        _d.label = 17;
                    case 17:
                        if (!(this.isEnable && onAccountsChanged)) return [3 /*break*/, 19];
