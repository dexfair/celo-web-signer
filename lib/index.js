...
var Celo = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!window['ethereum'].isMetaMask) return [3 /*break*/, 3];
                    ...
                    case 5:
                        ...
                        _b.label = 6;
                    case 6:
                        if (!(this.isEnable && onAccountsChanged)) return [3 /*break*/, 8];
    ...
    Celo.prototype.sendTransaction = function (web3Tx) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var txReceipt, provider_2, _a, temp, tx;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        txReceipt = null;
                    ...
                    case 6:
                        ...
                        _b.label = 7;
                    case 7: return [2 /*return*/, txReceipt];
                }
            });
        });
    };
