...
var Celo = /** @class */ (function () {
    ...
    Celo.prototype.init = function (onChainChanged, onAccountsChanged) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, transport, _c, _d, _e, transport, _f, _g, address;
            var _this = this;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 14:
                        ...
                        _h.label = 15;
                    case 15:
                        if (!(!this.isEnable && window['celo'])) return [3 /*break*/, 16];
                        ...
                        return [3 /*break*/, 20];
                    case 16:
                        if (!(!this.isEnable && window['ethereum'])) return [3 /*break*/, 20];
                        if (!window['ethereum'].isMetaMask) return [3 /*break*/, 18];
                    ...
                    case 19:
                        ...
                        _h.label = 20;
                    case 20:
                        if (!(this.isEnable && onAccountsChanged)) return [3 /*break*/, 22];
