...
var Celo = /** @class */ (function () {
    ...
    Celo.prototype.connect = function (onChainChanged, onAccountsChanged) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, transport, _b, _c, _d, transport, _e, _f, address;
            var _this = this;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        if (!((_g.sent()).length === 0)) return [3 /*break*/, 6];
                    ...
                    case 7:
                        if (!((_g.sent()).length > 0)) return [3 /*break*/, 10];
                    ...
                    case 16:
                        ...
                        _g.label = 17;
                    case 17:
                        if (!(!this.isEnable && window['celo'])) return [3 /*break*/, 18];
                        ...
                        return [3 /*break*/, 22];
                    case 18:
                        if (!(!this.isEnable && window['ethereum'])) return [3 /*break*/, 22];
                        if (!window['ethereum'].isMetaMask) return [3 /*break*/, 20];
                    ...
                    case 21:
                        ...
                        _g.label = 22;
                    case 22:
                        if (!(this.isEnable && onAccountsChanged)) return [3 /*break*/, 24];
    ...
    Celo.prototype.sendTransactionMetaMask = function (web3Tx) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var celoTx, signature, v, r, s, encodeTx, error_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
