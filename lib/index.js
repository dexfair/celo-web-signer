...
var Celo = /** @class */ (function () {
    ...
    Celo.prototype.connect = function (onChainChanged, onAccountsChanged) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var browser, _a, error_2, transport, _b, _c, _d, transport, _e, _f, address, _g;
            var _this = this;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        _h.sent();
                        if (!(!window['celo'] || !window['celo'].isMobile)) return [3 /*break*/, 19];
                        browser = detect();
                        if (!(browser && browser.name === 'chrome')) return [3 /*break*/, 12];
                        _a = !this.isEnable;
                    ...
                    case 4:
                        if (!((_h.sent()).length === 0)) return [3 /*break*/, 8];
                        _h.label = 5;
                    case 5:
                        _h.trys.push([5, 7, , 8]);
                    ...
                    case 9:
                        if (!((_h.sent()).length > 0)) return [3 /*break*/, 12];
                    ...
                    case 11:
                        ...
                        _h.label = 12;
                    case 12:
                        if (!(browser && browser.name === 'opera')) return [3 /*break*/, 19];
                        _d = !this.isEnable;
    ...
    Celo.prototype.changeNetwork = function (network) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.provider.isDesktop) return [3 /*break*/, 3];
                        this.kit = null;
                        this.kit = contractkit_1.newKit(network.provider);
                        _a = this;
                        return [4 /*yield*/, this.kit.web3.eth.getChainId()];
    ...
    Celo.prototype.fillTxDefaults = function (from, tx) {
        var defaultTx = {
            from: from,
            feeCurrency: this.kit.connection.defaultFeeCurrency,
            gasPrice: this.kit.connection.defaultGasPrice
        };
        return tslib_1.__assign(tslib_1.__assign({}, defaultTx), tx);
    };
    Celo.prototype.rlpEncodedTx = function (web3Tx) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var celoTx, gas, e_1, gasPrice, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        celoTx = this.fillTxDefaults(web3Tx.from, JSON.parse(JSON.stringify(web3Tx)));
                    ...
                    case 7:
                        ...
                        _a = celoTx;
                        return [4 /*yield*/, this.kit.web3.eth.getTransactionCount(web3Tx.from)];
                    case 8:
                        _a.nonce = _b.sent();
                        return [2 /*return*/, wallet_base_1.rlpEncodedTx(celoTx)];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.rlpEncodedTx(web3Tx)];
                    case 1:
                        celoTx = _a.sent();
                        return [4 /*yield*/, this.web3.eth.sign(wallet_base_1.getHashFromEncoded(celoTx.rlpEncode), celoTx.transaction.from)];
                    case 2:
                        signature = _a.sent();
                        v = this.kit.web3.utils.hexToNumber("0x" + signature.slice(130)) + (this.chainId * 2 + 8);
                        r = Buffer.from(signature.slice(2, 66), 'hex');
                        s = Buffer.from(signature.slice(66, 130), 'hex');
                        return [4 /*yield*/, wallet_base_1.encodeTransaction(celoTx, { v: v, s: s, r: r })];
                    case 3:
                        encodeTx = _a.sent();
                        return [2 /*return*/, connect_1.toTxResult(this.kit.web3.eth.sendSignedTransaction(encodeTx.raw))];
                    case 4:
                        error_3 = _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        tx = _b.sent();
                        txReceipt = connect_1.toTxResult(this.kit.web3.eth.sendSignedTransaction(tx)).waitReceipt();
                        return [3 /*break*/, 11];
                    case 7:
                    ...
                    case 10:
                        encodeTx = _b.sent();
                        txReceipt = connect_1.toTxResult(this.kit.web3.eth.sendSignedTransaction(encodeTx.raw)).waitReceipt();
                        _b.label = 11;
